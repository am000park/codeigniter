...
class Solapi {
    ...
    private $config['apiKey']    = "NCS50N4H7PXZINS8";
    private $config['apiSecret'] = "KN9PZDE2ICXLPW3NU5ENWGM7GGMMLOLA";
    private $config['PFID']      = "KA01PF200519061615961AhO9Hz8UDJ1"; //플러스친구아이디
    private $config['from']      = "07088996797";

    private $config['appId']     = "Zwk6yzx8kfhJ"; //레인아이 앱코드 변경, 삭제 절대금지!!!!
